...
export default function Offert() {
  const [setOffert, { error: errorMutationReview }] = useMutation(SET_OFFER, {
    refetchQueries: [
      { query: GET_PRODUCTS },
  ...
  const { data: offerData, loading: offerLoading } = useQuery(GET_OFFERTS, {
      ...
      <div className="discountContainer">
        ...
        <div>
          ...
          <ul className="activeUsers">
            ...
            {!offerLoading &&
              offerData.getOffers.map((offert) => (
                <li key={offert.id}>
                  <span>
